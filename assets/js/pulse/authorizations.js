...
var deleteActionViewModel = (function () {
    function deleteActionViewModel() {
        this.actionId = ko.observable();
    }
    return deleteActionViewModel;
}());
var addUpdateActionViewModel = (function () {
    function addUpdateActionViewModel() {
        this.actionId = ko.observable();
        this.resourceDescription = ko.observable();
        this.actionName = ko.observable();
        this.actionDescription = ko.observable();
    }
    return addUpdateActionViewModel;
}());
var deleteViewModel = new deleteActionViewModel();
ko.applyBindings(deleteViewModel, $('#deleteActionForm')[0]);
var addUpdateViewModel = new addUpdateActionViewModel();
...
var showingAddModal = true;
function addAction() {
    $.blockUI({ baseZ: 9000 });
    var data = ko.toJS(addUpdateViewModel);
    data.resourceName = $('#resourceName').val();
    var url = addActionUrl;
...
function descriptionFormatter(value, id) {
    if (value === null)
        return '';
    else
        return value;
...
$(function () {
    ...
    $('#resourceName').on('select2:select', function (e) {
        if (numberOfResults === 0 || showingAddModal === false) {
            ...
            $('#resourceDescriptionGroup').addClass('hide');
    });
});
